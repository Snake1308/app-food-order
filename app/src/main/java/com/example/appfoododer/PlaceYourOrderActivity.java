...
import com.example.appfoododer.adapter.PlaceYourOrderAdapter;
import com.example.appfoododer.model.Menu;
...
//        actionBar.setDisplayHomeAsUpEnabled(true);
    ...
    private void calculateTotalAmount(Restaurant restaurantModel) {
    ...
    private void onPlaceOrderButtonClick(Restaurant restaurantModel) {
